...
import settings_SPA as settings
from dataset_SPA import TrainValDataset, TestDataset
...
def save_image(derain, idx):
    ...
    cv2.imwrite(os.path.join(os.path.join('/media/ubuntu/Seagate/ACM_MM/experiment_res/Distillation/SPA/', 'norain-%d.png'%(idx + 1))), derain_save_np)
