...
# from torch.optim.lr_schedulder import MultiStepLR
from torch.optim.lr_scheduler import MultiStepLR
from torch.autograd import Variable
from torch.utils.data import DataLoader
import settings_Rain1400 as settings
from dataset_Rain1400 import TrainValDataset, TestDataset
...
class Session:
    def __init__(self):
        ...
        self.sche_net = MultiStepLR(self.opt_net, milestones=[settings.l1, settings.l2], gamma=0.1) # 0.2
...
def run_train_val(ckp_name_net='net_latest'): # 'net_latest'
    sess = Session()
    ...
    while sess.step < settings.total_step + 1:
        ...
        if sess.step % (settings.one_epoch) == 0:
            ...
            logfile = open('../log_test/' + 'val_Rain1400' + '.txt', 'a+')
