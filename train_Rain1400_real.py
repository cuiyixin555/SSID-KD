...
import settings_Rain1400_real as settings
from dataset_Rain1400_real import TrainValDataset, TestDataset
...
class Session:
    def __init__(self):
        ...
        dict_net = torch.load('./trained_model/Rain1400/net_latest')
...
def run_train_val(ckp_name_net='net_latest'):
    ...
    while sess.step < settings.total_step + 1:
        ...
        if sess.step % (settings.one_epoch) == 0:
            ...
            logfile = open('../log_test/' + 'Rain1400_real_val' + '.txt', 'a+')
